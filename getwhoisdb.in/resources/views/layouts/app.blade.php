...
<meta charset="utf-8">
    ...
    <!-- Website Title -->
    <title>Business Development Service</title>
    <!-- {{ asset('xxxxxx') }} -->
    <!-- Styles -->
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="{{url('')}}"><img src="{{ asset('images/logo.png') }}" alt="alternative"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="<?= (Auth::check()) ? route('home') : '#header' ?>">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services">Services</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{ Route('serviceplane')}}#serviceplace">Server planes</a>
                </li>
                <li class="nav-item">
                ...
                @if (Auth::check())
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{ route('pay') }}">Pay Now</a>
                </li>
                @else
                <!-- <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services">Services</a>
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{ Route('serviceplane')}}">Server planes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#pricing">Pricing</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    @guest
                        <li class="nav-item">
                                    <a class="nav-link page-scroll" href="{{ route('login') }}#login">{{ __('Login') }}</a>
                        </li>
                        @if (Route::has('register'))
                                    <li class="nav-item">
                                        <a class="nav-link page-scroll" href="{{ route('register') }}#register">{{ __('Register') }}</a>
                                    </li>
                        @endif
                    @else
                    <li class="nav-item dropdown">
